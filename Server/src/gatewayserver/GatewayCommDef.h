...
#define SEND2CLIENT(FD,MSGID,MSG) g_pGatewayNetProxy->SendMsg(MPMsg::MsgType::eMsgType_Client,MP_ST_GATE,MP_TCP_CLIENT,FD,MSGID,MSG);
#define SEND2CLIENT_ALL(MSGID,MSG) g_pGatewayNetProxy->SendMsgAll(MPMsg::MsgType::eMsgType_Client,MP_ST_GATE,MP_TCP_CLIENT,MSGID,MSG);
